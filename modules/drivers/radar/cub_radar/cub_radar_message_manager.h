...
class CubRadarMessageManager
    : public apollo::drivers::canbus::MessageManager<CubRadar> {
 public:
  explicit CubRadarMessageManager(
      const std::shared_ptr<apollo::cyber::Writer<CubRadar>> &writer);
  virtual ~CubRadarMessageManager() {}
  void set_radar_conf(RadarConf radar_conf);
  apollo::drivers::canbus::ProtocolData<CubRadar> *GetMutableProtocolDataById(
