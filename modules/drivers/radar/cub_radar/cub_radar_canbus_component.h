...
/**
 * @class CubRadarCanbus
 *
 * @brief template of canbus-based sensor module main class (e.g., cub_radar).
 */

class CubRadarCanbusComponent : public apollo::cyber::Component<> {
 public:
  CubRadarCanbusComponent();
  ~CubRadarCanbusComponent();
  bool Init() override;
 ...
 private:
  ...
  CubRadarConf cub_radar_conf_;
  std::shared_ptr<apollo::drivers::canbus::CanClient> can_client_;
  apollo::drivers::canbus::CanReceiver<CubRadar> can_receiver_;
  std::unique_ptr<CubRadarMessageManager> sensor_message_manager_;
