...
_ADAPTERCONFIG_MESSAGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUB_RADAR', index=74, number=76,
      options=None,
      type=None),
  ],
